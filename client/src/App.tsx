    ...
    <div className="app-container">
      <div className="switch">
        ...
        <span onClick={() => setMode(true)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill={mode ? "currentColor" : "grey"} viewBox="0 0 16 16">
        ...
        <span onClick={() => setMode(false)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill={mode ? "grey" : "currentColor"} viewBox="0 0 16 16">
